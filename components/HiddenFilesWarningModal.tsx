         ...
         <div className="relative z-10 flex flex-col items-center gap-6">
            ...
            <div className="bg-black/40 border border-zinc-700 p-4 rounded w-full flex items-center gap-4">
                 ...
                 <div className="text-left">
                     <p className="text-yellow-500 font-bold text-[10px] uppercase tracking-wider mb-1">Corrective Action</p>
                     <p className="text-zinc-300 text-xs font-mono">Press <span className="bg-zinc-200 text-black px-1.5 py-0.5 rounded font-bold mx-1">.</span> to conceal hidden files</p>
                 </div>
            </div>
         </div>
      </div>
