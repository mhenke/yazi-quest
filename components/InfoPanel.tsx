...
export const InfoPanel: React.FC<InfoPanelProps> = ({ file, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md bg-zinc-900 border border-zinc-700 shadow-2xl rounded-lg overflow-hidden"
      ...
      >
        ...
        <div className="px-4 py-2 bg-zinc-950 border-t border-zinc-800 text-center">
          <p className="text-[10px] text-zinc-600 font-mono">Press Tab to close</p>
        </div>
      </div>
    </div>
  );
