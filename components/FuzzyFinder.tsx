...
type ZoxideItem = { path: string; score: number };
type FzfItem = { path: string; pathIds?: string[]; type?: string; id?: string };
type Candidate = ZoxideItem | FzfItem;

const hasScore = (c: Candidate): c is ZoxideItem => {
  return (c as ZoxideItem).score !== undefined && typeof (c as ZoxideItem).score === 'number';
};
                  ...
                  >
                    <div className="flex items-center gap-4 truncate flex-1">
                      ...
                      {isZoxide && (
                        ...
                        >
                          {hasScore(item) ? item.score.toFixed(1) : ''}
                        </span>
                      )}
