...
export const FuzzyFinder = React.forwardRef<HTMLInputElement, FuzzyFinderProps>(
  ({ gameState, onSelect, onClose, onInputChange }, ref) => {
    ...
    return (
      ...
      >
        ...
        >
          <div className="flex items-center gap-3 text-lg w-full">
            <span
            ...
            <input
              ...
              placeholder="Search..."
              className={`w-full bg-transparent outline-none text-white font-bold placeholder:text-zinc-700`}
            />
          </div>
