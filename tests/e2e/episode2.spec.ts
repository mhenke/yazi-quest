...
test.describe('Episode 2: FORTIFICATION', () => {
  test.describe('Level 6: BATCH OPERATIONS', () => {
    ...
    test.afterEach(async ({ page }, testInfo) => {
      if (testInfo.status !== testInfo.expectedStatus) {
        const screenshotPath = `${testInfo.outputDir}/${testInfo.title.replace(/\s+/g, '_')}_fail.png`;
        await page.screenshot({ path: screenshotPath });
      }
    });

    test('completes recursive search and batch operations', async ({ page }, testInfo) => {
  ...
  test.describe('Level 7: QUANTUM BYPASS', () => {
    test.beforeEach(async ({ page }) => {
    ...
    test('completes FZF find and clipboard abort', async ({ page }, testInfo) => {
  ...
  test.describe('Level 8: DAEMON DISGUISE CONSTRUCTION', () => {
    test.beforeEach(async ({ page }) => {
    ...
    test('performs force overwrite', async ({ page }, testInfo) => {
  ...
  test.describe('Level 9: TRACE CLEANUP', () => {
    test.beforeEach(async ({ page }) => {
    ...
    test('selects, inverts, and deletes junk', async ({ page }, testInfo) => {
  ...
  test.describe('Level 10: CREDENTIAL HEIST', () => {
    test.beforeEach(async ({ page }) => {
    ...
    test('identifies and secures active key', async ({ page }, testInfo) => {
