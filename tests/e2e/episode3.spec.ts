...
test.describe('Episode 3: MASTERY', () => {
  test.describe('Level 11: DAEMON RECONNAISSANCE', () => {
    ...
    test('completes reconnaissance', async ({ page }, testInfo) => {
  ...
  test.describe('Level 12 Scenarios', () => {
    test.afterEach(async ({ page }, testInfo) => {
      if (testInfo.status !== testInfo.expectedStatus) {
        const screenshotPath = `${testInfo.outputDir}/${testInfo.title.replace(/\s+/g, '_')}_fail.png`;
        await page.screenshot({ path: screenshotPath });
  ...
  test.describe('Level 13: DISTRIBUTED CONSCIOUSNESS', () => {
    test.beforeEach(async ({ page }) => {
    ...
    test('gathers distributed keys', async ({ page }, testInfo) => {
      // Standard viewport
  ...
  test.describe('Level 14: STERILIZATION', () => {
    test.beforeEach(async ({ page }) => {
    ...
    test('permanently deletes all user data', async ({ page }, testInfo) => {
  ...
  test.describe('Level 15: TRANSMISSION PROTOCOL', () => {
    test.beforeEach(async ({ page }) => {
      test.setTimeout(60000);
    ...
    test('completes the cycle', async ({ page }, testInfo) => {
      // Task 1: Enter vault
