...
**Level 13+:** Includes L12 changes (moved systemd-core from workspace to '/daemons')  
...
- `?lvl=12` → systemd-core should be in workspace with credentials (from L10), NOT in '/daemons' yet (L12 task)
- `?lvl=14` → systemd-core should be in '/daemons' (from L12), '/home/guest' NOT empty yet (L14 task)
