...
export const LEVELS: Level[] = [
  ...
  // ========================================
  {
    ...
    hint: "Press 'j' to move down, 'k' to move up. Press 'l' to enter a directory, 'h' to go back. Navigate to 'datastore'. Then press 'h' repeatedly to return to root (/), and enter 'etc'.",
  ...
  },
  {
    ...
    hint: "Press 'f', type 'map'. Use j/k to highlight 'target_map.png'. Press Esc to exit filter. Press 'x' to cut. Navigate to 'media' (press 'h' then enter it). Press 'p' to paste.",
  ...
  // ========================================
  {
    ...
    initialPath: ['root', 'home', 'user', 'workspace'],
    hint: "Highlight 'neural_net'. Press 'r', type 'systemd-core', Enter. Navigate inside, then enter 'weights'. Highlight 'model.rs'. Press 'r', type 'kernel.so', Enter.",
    coreSkill: "Rename (r)",
  ...
  },
  {
    ...
    initialPath: ['root'],
    hint: "Press 'l' to enter 'home', 'l' for 'guest', 'l' for 'datastore'. Highlight 'mission_log.md' with j/k. Press 'd' to delete, confirm with 'y'. Press 'h' repeatedly to return to root (/).",
