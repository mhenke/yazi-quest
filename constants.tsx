...
export const LEVELS: Level[] = [
  ...
  },
  {
    ...
    description: "CRITICAL ASSET RELAY. Your cryptographic key (in datastore/vault) and mission log (in datastore) require modification in a secure environment. Use fuzzy find (z) to locate files instantly and Zoxide (Shift+Z) to teleport between directories. Manual navigation will leak execution time. Round-trip migration must complete within 120 seconds.",
    initialPath: ['root', 'home', 'user', 'docs'],
    ...
    coreSkill: "Speed Navigation (z + Shift+Z + x/p)",
