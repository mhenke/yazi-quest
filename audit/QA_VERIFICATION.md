...
- **Case 1.1:** History Navigation (`Shift+H`/`Shift+L`) has been re-implemented. ✅
- **Case 1.2:** Preview Pane Scrolling (`Shift+J`/`Shift+K`) has been re-implemented. ✅
...
- **Case 1.2:** Documentation was found to reference non-existent features (`Shift+H/L`), deleted code (`useFilesystem.ts`), and an outdated level progression. ✅
